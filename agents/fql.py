...
from utils.networks import ActorVectorField, Value, ResValue
...
class FQLAgent(flax.struct.PyTreeNode):
    ...
    def actor_loss(self, batch, grad_params, rng):
        ...
        return actor_loss, {
            ...
            'mean_bc_flow_loss': bc_flow_loss.mean(),
    ...
    def create(
        ...
        if config['use_resnets']:
            ...
            ) #assume return_dim = 1 implicitly
...
def get_config():
    config = ml_collections.ConfigDict(
        dict(
            ...
            block_width=512,
            block_depth=4,
            value_num_ensembles=2,
            use_resnets = False,
            num_transformations = 2,
            activate_before_layernorm=True,
        )
    )
    return config