...
# PAC-FQL actor batch launcher for puzzle-4x4.
...
usage() {
  cat <<'EOF'
Usage:
  ./run_batch_puzzle_3.sh --alpha A [--offline_steps N] [--project_name PROJECT] [--critic_lr LR] [--actor_lr LR]
